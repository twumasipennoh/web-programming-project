	...
	<header>
      ...
      <nav id="nav_menu">
        <ul>
		  ...
		  <li><a href="../pages/adminEmpDirectory.php?employeeID=<?php echo $employeeID ?>" class="current">Employee Directory</a></li>
...
<form action="../pages/adminEmpDirectory.php?employeeID=<?php echo $employeeID ?>" name="filter" method="POST">
